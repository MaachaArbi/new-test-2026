...
final class ErrorsTranslationCatalogueTest extends KernelTestCase
{
    ...
    private function existingDomainErrorCodes(): array
    {
        return [
            ...
            BookingSettlementAlreadyActiveException::forTriplet(1, 'distributor', 2)->errorCode(),
            ...
            InvalidCashPaymentMethodRoutingException::inconsistentTracking('none', 'individual')->errorCode(),
            ...
            CashReceiveInstrumentRoutingNotCaisseException::forPaymentMethod(1, 'none')->errorCode(),
