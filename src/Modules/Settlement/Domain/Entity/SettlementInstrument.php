 ...
 */
final class SettlementInstrument
{
    /**
    ...
    private function __construct(
        ...
        private SettlementInstrumentStatus $statusCode,
    ...
    public static function create(
        ...
        if ($amountMinor <= 0) {
            throw InvalidSettlementInstrumentException::amountMustBePositive($amountMinor);
        }
        ...
        return new self(
            ...
            issuedOn: $issuedOn,
            metadata: $metadata,
            statusCode: SettlementInstrumentStatus::Active,
     ...
     */
    public function transitionStatus(SettlementInstrumentStatus $newStatus, ?string $reason = null): void
    {
        if ($this->statusCode === $newStatus) {
            throw SettlementInstrumentStatusUnchangedException::forStatus($newStatus->value);
        }
    ...
    public function statusCode(): SettlementInstrumentStatus
    {
