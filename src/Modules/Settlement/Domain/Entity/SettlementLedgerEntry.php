 ...
 */
final class SettlementLedgerEntry
{
    ...
    public static function post(
        ...
        if ($amountMinor === 0) {
            throw InvalidSettlementLedgerEntryException::amountMustBeNonZero($amountMinor);
        }
        ...
        if (
            ...
            throw InvalidSettlementLedgerEntryException::originRequired();
        }
