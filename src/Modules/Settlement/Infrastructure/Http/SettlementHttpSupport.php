...
namespace App\Modules\Settlement\Infrastructure\Http;
 ...
 */
final class SettlementHttpSupport
{
    public static function requireInstrumentByPublicId(
        SettlementInstrumentRepositoryInterface $instrumentRepository,
        string $publicId,
        ...
        if ($instrument === null) {
            throw SettlementInstrumentNotFoundException::forPublicId($publicId);
        }
