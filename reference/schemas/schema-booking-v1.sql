...
--                   ajout service 'guide', FK pointvente_id/pointvente_paiement_id.
-- Date           : 2026-07-20
...
--                   pointvente (module pointvente_, schema-pointvente-v1.sql)
...
CREATE TABLE booking (
    ...
    pointvente_paiement_id                                                             BIGINT REFERENCES pointvente(id),
